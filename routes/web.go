...
func RegisterWebRoutes(r *mux.Router) {
	...
	r.HandleFunc("/categories/{id:[0-9]+}/edit", cc.Edit).Methods("GET").Name("categories.edit")
	r.HandleFunc("/categories/{id:[0-9]+}", cc.Show).Methods("GET").Name("categories.show")
	r.HandleFunc("/categories/{id:[0-9]+}", cc.Update).Methods("POST").Name("categories.update")
